...
namespace DiffieHellmanWebApp
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            ulong firstPerson = DiffieHellman.calc(commonPrimeNum, secretKeyOne, commonNum);
            ulong buffer = firstPerson;
            ulong secondPerson = DiffieHellman.calc(commonPrimeNum, secretKeyTwo, commonNum);
            firstPerson = secondPerson;
            secondPerson = buffer;
            firstPerson = DiffieHellman.calc(firstPerson, secretKeyOne, commonPrimeNum);
            secondPerson = DiffieHellman.calc(secondPerson, secretKeyTwo, commonPrimeNum);
