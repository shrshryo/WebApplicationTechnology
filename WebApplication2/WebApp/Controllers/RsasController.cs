...
namespace WebApp.Controllers
{
    public class RsasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,FirstPrimeNum,SecondPrimeNum,CipherText")] Rsa rsa)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FirstPrimeNum,SecondPrimeNum,CipherText")] Rsa rsa)
        {
            if (id != rsa.Id)
            {
                return NotFound();
